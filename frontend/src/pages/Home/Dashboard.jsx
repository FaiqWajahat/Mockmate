      ...
      <div className="container mx-auto pt-4 pb-4 overflow-hidden relative">
        ...
        <div className="fixed bottom-4 sm:bottom-6 md:bottom-10 left-1/2 -translate-x-1/2 flex gap-2 sm:gap-4">
          <div className="bg-black/10 backdrop-blur-md p-2 rounded-full flex gap-2 sm:gap-3 border border-gray-200/30">
            <button
              className="h-10 sm:h-12 hover:scale-105 ease-in-out duration-300 flex items-center justify-center gap-2 bg-white text-black rounded-full transition-all cursor-pointer px-4 sm:px-5 py-2 text-xs sm:text-sm font-semibold"
            ...
            <button
              className="h-10 sm:h-12 flex hover:scale-105 ease-in-out duration-300 items-center justify-center gap-2 bg-white text-black rounded-full transition-all cursor-pointer px-4 sm:px-5 py-2 text-xs sm:text-sm font-semibold"
            ...
            <button
              className="h-10 sm:h-12 flex items-center hover:scale-105 ease-in-out duration-300 justify-center bg-[#fcfcfc] text-black rounded-full transition-all  cursor-pointer px-4 sm:px-5 py-2 border border-gray-100 shadow-[0_2px_10px_rgba(0,0,0,0.02)] hover:shadow-[0_4px_15px_rgba(0,0,0,0.05)] hover:bg-white"
